# InfraSync-AI — Intelligent Data Capture & Schedule-Linking Layer

**Problem Statement:** SIH26122  
**Project Name:** InfraSync-AI  
...
- **Backend**: Python 3.10+ (tested on Python 3.14), FastAPI, Uvicorn, SQLite, Pydantic, Scikit-learn, Pandas, OpenPyXL
- **Frontend**: React 18, TypeScript, Vite, Recharts, Lucide React, CSS
- **Testing**: Pytest, HTTPX (41 passing unit and integration tests)
- **AI Matching Engine**: Multi-signal similarity (TF-IDF + Domain Lexicon + Fuzzy string matching + Confidence policy + Deterministic Fallback, with optional OpenAI / Gemini LLM providers)
